 ...
 */
#define READ16(highbyte, lowbyte) (uint16_t)(((uint8_t)highbyte << 8) | (uint8_t)lowbyte)

/**
 * @brief Converts four separate 8-bit values to a single 32-bit value
 */
#define READ32(highbyte, midhighbyte, midlowbyte, lowbyte) (uint32_t)(((uint8_t)highbyte << 24) | ((uint8_t)midhighbyte << 16) | ((uint8_t)midlowbyte << 8) | (uint8_t)lowbyte)
 ...
 */
#define MSB16(value) (uint8_t)(((uint16_t)value >> 8) & 0xFF)
